...
/*   Updated: 2023/10/22 21:10:08 by tmejri           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// void	put_pix_annex(t_map *map, t_textures *img, t_coord *c);
void	put_pix_annex(t_map *map, t_textures *img, t_coord *c, t_mlx *mlx);
void	put_pixel(t_textures *img, int x, int y, int color);
// void	draw_grille(t_textures *img, t_map *map);
// void	draw_grille_annex(t_textures *img, t_coord *c);
